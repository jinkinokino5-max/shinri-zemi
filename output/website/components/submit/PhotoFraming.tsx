...
/* ══════════════════════════════════════════════════════════════════
   ...
   根拠：draft/デザイン大本資料_v1.md 6-4（フォールバック）／ lib/schema.ts の Focus
   ...
   ⚠ 2026-08-13：写真の加工（白黒＋朱）は廃止された。
     プレビューが本物と食い違わないのは、Thumb をそのまま使っているからで、
     加工の有無をこのファイルが知る必要はない。この構造を崩さないこと。
  ...
  return (
    <div className={s.wrap}>
      <p className={s.caption}>
        ...
        {/* ⚠ 色は変えないが、切り抜きは場所ごとに変わる。
              「そのまま出る」とだけ言うと、切られることが伝わらない。 */}
        <span className={s.captionNote}>
          色はそのまま出ます。ただし、出る場所ごとに枠の形が違うので、切り抜かれ方が変わります。
        </span>
      </p>
...
function FocusEditor({
  ...
  return (
    <div className={s.editor}>
      ...
      >
        {/* ⚠ ここは Thumb を使わない。切り抜かれる前の全体を見せる枠だからで、
              加工の有無とは関係がない。上のプレビューが「切り抜き後」、
              こちらが「切り抜く前」という役割の違いである。 */}
